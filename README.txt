...
Location.java            -Creates Location objects which fill the plane in the simulation, consists of a seated and standing passenger
...
1.In the main method of the Plane file, choose the queue generator based on the type of algorithm you want to test.
  -Note:getRandomPassengerQueue boards the plane in a random order, getPassengerQueueWindowToAisle boards the plane back to front and window seat to aise seat,
